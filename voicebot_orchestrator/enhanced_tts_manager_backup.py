...
import os
import tempfile
import soundfile as sf                # Save audio using working method
                if save_path:
                    # Use centralized audio output
                    if not os.path.isabs(save_path):
                        output_path = audio_manager.get_audio_path(save_path, "nari_dia")
                    else:
                        output_path = save_path
                else:
                    # Generate timestamped path in centralized directory
                ...
                return audio_bytes, generation_time, "Nari Dia"rt Optional, Union, Literal
